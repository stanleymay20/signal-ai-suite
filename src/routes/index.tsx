  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-x-0 -top-32 mx-auto h-72 max-w-3xl rounded-full bg-emerald/20 blur-3xl" aria-hidden />
        <div className="relative mx-auto max-w-6xl px-6 pt-20 pb-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
              TimeSeriesGPT is ChatGPT for analysts. Upload a dataset, ask anything,
              and get explainable forecasts, anomaly detection, and executive briefings —
              with every number traceable to source.
            </p>
            ...
            <div className="space-y-4 p-6 font-mono text-sm">
              ...
              <div className="rounded-md border border-emerald/30 bg-emerald/5 p-4 text-sm">
                ...
                <p className="mt-2 text-foreground/90">
                  Q4 revenue projected at <span className="font-semibold">$48.2M ± $2.1M</span>{" "}
                  (95% CI). Seasonality dominated by a Black-Friday spike (+38% baseline)
                  and a mid-December plateau. Three anomalies flagged in Sep — likely
                  promo-driven.
                </p>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-muted-foreground">
              Built on the principle that every prediction must be explainable, every
              answer grounded, and every model swappable.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <ol className="space-y-6">
              {[
                ["Upload", "Drop a CSV, Excel or TSV. We profile schema, types, nulls and duplicates."],
                ["Explore", "Auto-generated trend, seasonality and correlation charts with an executive summary."],
                ["Forecast", "Prophet, ARIMA, SARIMA, ES, XGBoost — we recommend the winner and explain why."],
      ...
      {/* Stack */}
      <section id="stack" className="border-t border-border bg-primary py-24 text-primary-foreground">
        <div className="mx-auto max-w-6xl px-6 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm text-primary-foreground/70">
            TimeSeriesGPT speaks Ollama, vLLM, OpenAI-compatible APIs, Qwen, DeepSeek
            and Llama. Run fully local for regulated industries.
          </p>
          ...
          <div className="mt-10">
            <Link to="/auth">
              <Button
                size="lg"
                className="h-12 bg-gold px-8 text-gold-foreground hover:bg-gold/90"
              >
      ...
      <footer className="border-t border-border py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 text-sm text-muted-foreground md:flex-row">
          <Logo />
          <p className="font-mono text-xs">© {new Date().getFullYear()} TimeSeriesGPT · SignalGPT</p>
        </div>
      </footer>
    </div>
  );
